...
public interface AuthService {
     ...
     * @return 登录响应参数
     */
    LoginResp candidatesOrInviteLogin(LoginReq req, HttpServletRequest request);
     ...
     * @return 登录响应参数
     */
    LoginResp examLogin(LoginReq req, HttpServletRequest request);
     ...
     * @param req 修改密码请求参数
     */
    boolean forgotPassword(UserReq req);
