...
public interface LoginHandler<T extends LoginReq> {
     ...
     * @return 登录响应参数
     */
    LoginResp candidatesOrInviteLogin(T req, ClientResp client, HttpServletRequest request);

    LoginResp examLogin(T req, ClientResp client, HttpServletRequest request);

    LoginResp invigilatorLogin(T req, ClientResp client, HttpServletRequest request);
