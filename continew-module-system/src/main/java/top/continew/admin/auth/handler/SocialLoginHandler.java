...
public class SocialLoginHandler extends AbstractLoginHandler<SocialLoginReq> {
    ...
    @Override
    public LoginResp candidatesOrInviteLogin(SocialLoginReq req, ClientResp client, HttpServletRequest request) {
        return null;
    }

    @Override
    public LoginResp examLogin(SocialLoginReq req, ClientResp client, HttpServletRequest request) {
        return null;
    }

    @Override
    public LoginResp invigilatorLogin(SocialLoginReq req, ClientResp client, HttpServletRequest request) {
        return null;
    }
