...
public class EmailLoginHandler extends AbstractLoginHandler<EmailLoginReq> {
    ...
    @Override
    public LoginResp candidatesOrInviteLogin(EmailLoginReq req, ClientResp client, HttpServletRequest request) {
        return null;
    }

    @Override
    public LoginResp examLogin(EmailLoginReq req, ClientResp client, HttpServletRequest request) {
        return null;
    }
