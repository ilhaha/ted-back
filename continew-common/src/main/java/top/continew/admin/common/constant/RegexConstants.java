...
public class RegexConstants {
    ...
    /**
     * 用户名正则（用户名长度为 4-255 个字符，支持大小写字母、数字、下划线）
     */
    public static final String USERNAME = "^.{4,255}$";
     ...
     * 身份证正则
     */
    public static final String ID_CARD_REGEX = "^[1-9]\\d{5}(18|19|20)\\d{2}((0[1-9])|(10|11|12))(([0-2][1-9])|10|20|30|31)\\d{3}[0-9X]$";
