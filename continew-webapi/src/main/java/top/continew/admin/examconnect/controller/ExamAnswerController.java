 ...
 */
@Tag(name = "考生答题，记录考生答题情况管理 API")
@RestController
@CrudRequestMapping(value = "/examconnect/examAnswer", api = {Api.PAGE, Api.DETAIL, Api.ADD, Api.UPDATE, Api.DELETE,
    Api.EXPORT})
public class ExamAnswerController extends BaseController<ExamAnswerService, ExamAnswerResp, ExamAnswerDetailResp, ExamAnswerQuery, ExamAnswerReq> {
