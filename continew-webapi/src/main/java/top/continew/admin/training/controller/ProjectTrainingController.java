 ...
 */
@Tag(name = "项目培训关联管理 API")
@RestController
@CrudRequestMapping(value = "/training/projectTraining", api = {Api.PAGE, Api.DETAIL, Api.ADD, Api.UPDATE, Api.DELETE,
    Api.EXPORT})
public class ProjectTrainingController extends BaseController<ProjectTrainingService, ProjectTrainingResp, ProjectTrainingDetailResp, ProjectTrainingQuery, ProjectTrainingReq> {}