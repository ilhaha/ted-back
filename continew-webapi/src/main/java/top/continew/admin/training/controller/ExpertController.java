...
@Tag(name = "专家信息管理 API")
@RestController
@CrudRequestMapping(value = "/training/expert", api = {Api.PAGE, Api.DETAIL, Api.ADD, Api.UPDATE, Api.DELETE,
    Api.EXPORT})
public class ExpertController extends BaseController<ExpertService, ExpertResp, ExpertDetailResp, ExpertQuery, ExpertReq> {

    @Resource
    private ExpertService expertService;

    @GetMapping("/getExpertById/{id}")
    public ExpertDetailResp getExpertById(@PathVariable Long id) {
