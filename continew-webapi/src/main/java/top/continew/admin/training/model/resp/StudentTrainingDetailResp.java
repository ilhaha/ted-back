...
@Schema(description = "学生培训详情信息")
public class StudentTrainingDetailResp extends BaseDetailResp {
    ...
    @ExcelProperty(value = "0-学习中 1-已完成 2-未开始")
