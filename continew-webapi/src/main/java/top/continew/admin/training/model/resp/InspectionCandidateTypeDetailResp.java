...
@Schema(description = "检验考生类型详情信息")
public class InspectionCandidateTypeDetailResp extends BaseDetailResp {
     ...
     * 禁考项目
     */
    @Schema(description = "禁考项目")
    @ExcelProperty(value = "禁考项目")
    private String disableProjectNames;
}