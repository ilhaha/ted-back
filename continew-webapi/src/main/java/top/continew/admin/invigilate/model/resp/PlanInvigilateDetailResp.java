...
@Schema(description = "考试计划监考人员关联详情信息")
public class PlanInvigilateDetailResp extends BaseDetailResp {
    ...
    //    @ExcelProperty(value = "监考状态（0：未确认，1：已确认，2：已完成）")
    ...
    @ExcelProperty(value = "监考状态（0：未监考，1：待录入，2：待审核， 3：已完成）")
    private Integer invigilateStatus;
