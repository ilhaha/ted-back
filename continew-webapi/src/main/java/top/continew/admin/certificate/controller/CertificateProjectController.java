 ...
 */
@Tag(name = "证件项目关联管理 API")
@RestController
@CrudRequestMapping(value = "/certificate/certificateProject", api = {Api.PAGE, Api.DETAIL, Api.ADD, Api.UPDATE,
    Api.DELETE, Api.EXPORT})
public class CertificateProjectController extends BaseController<CertificateProjectService, CertificateProjectResp, CertificateProjectDetailResp, CertificateProjectQuery, CertificateProjectReq> {}