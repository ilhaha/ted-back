...
@Schema(description = "资料核心存储详情信息")
public class DocumentDetailResp extends BaseDetailResp {
    ...
    @ExcelProperty(value = "存储路径(如/img/身份证正面.jpg)")
    ...
    @ExcelProperty(value = "关联资料类型名称")
    private String typeName;
    /**
     * 审核状态:0:待审核;1:已生效;2:未通过;
     */
    @Schema(description = "审核状态:0:待审核;1:已生效;2:未通过;")
    @ExcelProperty(value = "审核状态:0:待审核;1:已生效;2:未通过;")
