 ...
 */
@Tag(name = "考试通知与考试计划关联管理 API")
@RestController
@CrudRequestMapping(value = "/exam/examNoticePlan", api = {Api.PAGE, Api.DETAIL, Api.ADD, Api.UPDATE, Api.DELETE,
    Api.EXPORT})
public class ExamNoticePlanController extends BaseController<ExamNoticePlanService, ExamNoticePlanResp, ExamNoticePlanDetailResp, ExamNoticePlanQuery, ExamNoticePlanReq> {}