 ...
 */
@Data
@Schema(description = "创建或修改考生试卷参数")
public class CandidateExamPaperReq implements Serializable {
    ...
    @NotBlank(message = "试卷 JSON 内容不能为空")
    @Length(max = 1073741824, message = "试卷 JSON 内容长度不能超过 {max} 个字符")
