...
public interface EnrollMapper extends BaseMapper<EnrollDO> {
    ...
    boolean existsValidEnroll(@Param("examPlanId") Long examPlanId, @Param("userId") Long userId);
    ...
    List<EnrollResp> downloadSummaryList(@Param(Constants.WRAPPER) QueryWrapper<EnrollDO> queryWrapper,
                                         @Param("residencePermitId") Long residencePermitId);
    ...
    IPage<EnrollResp> getInspectorApplyList(@Param("page") Page<EnrollDO> page,
                                            @Param(Constants.WRAPPER) QueryWrapper<EnrollDO> queryWrapper);
